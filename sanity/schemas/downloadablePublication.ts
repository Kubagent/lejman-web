...
export default defineType({
  name: 'downloadablePublication',
  title: 'Downloadable Publication',
  type: 'document',
  description: 'Publications like books, catalogs, and PDFs available for download in the About section',
  fields: [
    defineField({
      name: 'title',
      title: 'Title',
